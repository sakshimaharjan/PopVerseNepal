  ...
  return (
    <AdminLayout>
      ...
      {showOrderDetails && selectedOrder && (
        <div className="fixed inset-0 backdrop-blur-md bg-opacity-500 flex items-center justify-center z-50 p-4">
          <div className="bg-white border border-amber-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
