    ...
    >
      <div className="max-w-7xl mx-auto px-3 flex justify-between items-center">
        <Link to="/" className="flex items-center">
          <img src="../../logo.png" alt="PopVerseNepal Logo" className="scale-110 md:scale-130 h-16 md:h-20 w-auto" />
        </Link>
            ...
            {currentUser ? (
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  className="text-left cursor-pointer text-red-600 hover:text-red-700 py-2 transition-colors flex items-center gap-2"
                >
                  <FiLogOut size={18} />
                  <span>Logout</span>
                </button>
